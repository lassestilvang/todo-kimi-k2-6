...
describe('TaskDecisionTab', () => {
  ...
  describe('Initial Render', () => {
    it('renders the component with title', () => {
      render(<TaskDecisionTab task={mockTask} />);
    ...
    it('shows empty state when no decisions', () => {
      render(<TaskDecisionTab task={mockTask} decisions={[]} />);
  ...
  describe('Add Decision Form', () => {
    ...
    it('shows question input in form', () => {
      ...
      expect(
        screen.getByPlaceholderText('What decision are you making?')
      ).toBeInTheDocument();
    });
    ...
    it('shows rationale textarea in form', () => {
      ...
      expect(
        screen.getByPlaceholderText('Why are you making this decision?')
      ).toBeInTheDocument();
    });
    ...
    it('displays existing decisions', () => {
      const decisions: DecisionEntry[] = [
        createMockDecision({
          ...
          rationale: "Yes, it's a good idea",
        }),
      ];

      render(<TaskDecisionTab task={mockTask} decisions={decisions} />);
  ...
  describe('Decision Deletion', () => {
    it('has edit and delete buttons for decisions', () => {
      const decisions: DecisionEntry[] = [createMockDecision({ id: 1 })];
  ...
  describe('API Integration', () => {
    it('calls API when adding decision', async () => {
      ...
      fireEvent.change(questionInput, {
        target: { value: 'Test decision question' },
      });
  ...
  describe('Edge Cases', () => {
    ...
    it('handles null task', () => {
      const { container } = render(<TaskDecisionTab task={null as any} />);
