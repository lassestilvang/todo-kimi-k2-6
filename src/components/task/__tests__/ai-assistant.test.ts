...
describe('AI Edit Command Logic', () => {
  ...
  describe('AI Provider Selection', () => {
    it('should select openai as provider when configured', () => {
      ...
      const activeProvider = mockStatus.openai
        ? 'openai-gpt4'
        : mockStatus.anthropic
          ? 'claude-sonnet'
          : 'keyword-parser';
...
describe('AI Assistant - Logic Tests', () => {
  ...
  describe('Duration Estimation', () => {
    it('should estimate duration for meetings', () => {
      ...
      const matchedDuration = Object.entries(durationKeywords).find(([k]) =>
        text.includes(k)
      );
  ...
  describe('List Classification', () => {
    ...
    it('should classify work-related tasks', () => {
      ...
      const matchedList = Object.entries(listKeywords).find(([k]) =>
        text.includes(k)
      );
