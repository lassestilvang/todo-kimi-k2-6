...
export function SmartFocusMode({ task, open, onOpenChange }: SmartFocusModeProps) {
            ...
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <div className="flex gap-2">
                ...
                <Button variant="ghost" size="sm" onClick={toggleFullscreen}>
                  {isFullscreen ? <Minimize2 className="h-4 w-4" /> : <Focus className="h-4 w-4" />}
                </Button>
                <X className="h-5 w-5 cursor-pointer" onClick={() => onOpenChange(false)} />
              </div>
            </CardHeader>
