...
describe("Task Health Score", () => {
  ...
  it("should give bonus for well-described tasks", () => {
    const task = {
      ...
      date: null,
      completed: false,
      description: "This is a detailed description that explains the task thoroughly and provides context for the user to understand what needs to be done in detail.",
  ...
  it("should calculate attention status for medium priority task due soon", () => {
    ...
    const task = {
      ...
      date: tomorrow,
      completed: false,
      description: "This is a very detailed description that exceeds one hundred characters for proper scoring in the health calculation algorithm",
