...
test.describe("Calendar Integration Tests", () => {
  ...
  test("should navigate between months", async ({ page }) => {
    ...
    await expect(page.locator('button[aria-label*="next"], button[aria-label*="Previous"]')).toBeVisible();
  ...
  test("should create task from calendar", async ({ page }) => {
    ...
    await page.fill('input[placeholder="What needs to be done?"]', "Quick Task from Calendar");
    await page.click('button:has-text("Create Task")');
  ...
  test("should show completed tasks differently", async ({ page }) => {
    ...
    await page.click('button:has-text("New Task")');
    await page.fill('input[placeholder="What needs to be done?"]', "Completed Calendar Task");
