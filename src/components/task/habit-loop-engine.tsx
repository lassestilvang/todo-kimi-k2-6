    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            <p className="text-2xl font-bold">
              {getCurrentStreak(defaultHabits)}
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-2xl font-bold">
              {Math.round(
                (defaultHabits.reduce((sum, h) => sum + h.success_score, 0) /
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-2xl font-bold">
              {Math.round(
                (defaultHabits.reduce((sum, h) => sum + h.completion_rate, 0) /
                  defaultHabits.length) *
                  100
              )}
              %
          ...
          <div className="grid md:grid-cols-5 gap-4">
            {[
              ...
              },
              {
                step: 'Craving',
                icon: '🧠',
                description: 'Wanting the reward',
              },
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            "When [trigger], I will [response]" - concrete plans for habit
            success
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            {[
              ...
              {
                trigger: 'When I reach my desk',
                response: 'Review my top 3 priorities',
              },
              {
                trigger: 'When I hit 2pm energy dip',
                response: 'Take a 5-minute walk',
              },
            ].map((intent, i) => (
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li className="flex gap-2">
                  ...
                  <span>
                    Consider reducing habit difficulty - you're overcommitted
                  </span>
                </li>
              </ul>
            </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            <div
              className={cn(
                ...
                completionHabits.some(h => h.streak >= 7)
            ...
            <div
              className={cn(
                'p-3 rounded-lg border text-center',
                completionHabits.some(h => h.streak >= 30)
            ...
            <div
              className={cn(
                'p-3 rounded-lg border text-center',
                completionHabits.some(h => h.success_score >= 0.8)
            ...
            <div
              className={cn(
                'p-3 rounded-lg border text-center',
                completionHabits.some(h => h.streak >= 100)
            ...
            <div
              className={cn(
                'p-3 rounded-lg border text-center',
                defaultHabits.every(h => h.completion_rate > 0.5)
