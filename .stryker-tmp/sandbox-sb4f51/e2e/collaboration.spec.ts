...
test.describe("Collaboration Features", () => {
  ...
  test("should create a task", async ({ page }) => {
    ...
    await page.fill('input[placeholder="What needs to be done?"]', "Collab Task");
  ...
  test("should open task comments tab", async ({ page }) => {
    // Create a task
    await page.click('button:has-text("New Task")');
    await page.fill('input[placeholder="What needs to be done?"]', "Comment Task");
    await page.click('button:has-text("Create Task")');
    ...
    await expect(page.locator('textarea[placeholder*="comment"], .comment-input')).toBeVisible();
  });

  test("should add a comment to task", async ({ page }) => {
    // Create a task
    await page.click('button:has-text("New Task")');
    await page.fill('input[placeholder="What needs to be done?"]', "Task with Comments");
    await page.click('button:has-text("Create Task")');
  ...
  test("should share a task", async ({ page }) => {
    // Create a task
    await page.click('button:has-text("New Task")');
    await page.fill('input[placeholder="What needs to be done?"]', "Shareable Task");
    await page.click('button:has-text("Create Task")');
    ...
    await expect(page.locator('input[placeholder*="share"], .share-link')).toBeVisible();
  });

  test("should set share permissions", async ({ page }) => {
    // Create a task
    await page.click('button:has-text("New Task")');
    await page.fill('input[placeholder="What needs to be done?"]', "Permission Task");
    await page.click('button:has-text("Create Task")');
  ...
  test("should view task activity log", async ({ page }) => {
    // Create a task
    await page.click('button:has-text("New Task")');
    await page.fill('input[placeholder="What needs to be done?"]', "Activity Log Task");
    await page.click('button:has-text("Create Task")');
  ...
  test("should see activity after editing task", async ({ page }) => {
    // Create a task
    await page.click('button:has-text("New Task")');
    await page.fill('input[placeholder="What needs to be done?"]', "Edit Activity Task");
    await page.click('button:has-text("Create Task")');
    ...
    // Edit the task
    await page.fill('input[placeholder="What needs to be done?"]', "Edit Activity Task Updated");
  ...
  test("should handle task assignment", async ({ page }) => {
    // Create a task
    await page.click('button:has-text("New Task")');
    await page.fill('input[placeholder="What needs to be done?"]', "Assignment Task");
    await page.click('button:has-text("Create Task")');
    ...
    await expect(page.locator('input[placeholder*="assign"], .assignee-search')).toBeVisible();
  });

  test("should collaborate on comments", async ({ page }) => {
    // Create a task
    await page.click('button:has-text("New Task")');
    await page.fill('input[placeholder="What needs to be done?"]', "Collaboration Task");
    await page.click('button:has-text("Create Task")');
