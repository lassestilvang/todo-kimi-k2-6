...
describe("task-helpers - Full Branch Coverage", () => {
  ...
  describe("logTaskAction function logic", () => {
    ...
    it("should have correct database SQL structure", () => {
      const sql = "INSERT INTO task_logs (task_id, action, details) VALUES (?, ?, ?)";
    ...
    it("should handle different action types", () => {
      const actions = ["create", "update", "delete", "complete", "archive", "unarchive"];
  ...
  describe("Database operations", () => {
    it("should prepare INSERT statement with correct columns", () => {
      ...
      expect(sql).toBe("INSERT INTO task_logs (task_id, action, details) VALUES (?, ?, ?)");
    });
