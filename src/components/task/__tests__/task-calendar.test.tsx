...
describe('TaskCalendar Component', () => {
  ...
  describe('Component Structure', () => {
    ...
    it('should render with proper container structure', () => {
      const { container } = render(
        <TaskCalendar tasks={[]} onTaskClick={mockOnTaskClick} />
      );
  ...
  describe('Task Display', () => {
    ...
    it('should display tasks with dates', () => {
      const tasks = [
        createMockTask({ id: 1, name: 'Test Task', priority: 'high' }),
      ];
    ...
    it('should not display tasks without dates', () => {
      const tasks = [
        createMockTask({ id: 1, name: 'No Date Task', date: null }),
      ];
      render(<TaskCalendar tasks={tasks} onTaskClick={mockOnTaskClick} />);
  ...
  describe('Priority Colors', () => {
    it('should render tasks with critical priority with red color', () => {
      const tasks = [
        createMockTask({ id: 1, name: 'Critical Task', priority: 'critical' }),
      ];
      const { container } = render(
        <TaskCalendar tasks={tasks} onTaskClick={mockOnTaskClick} />
      );
    ...
    it('should render tasks with high priority with orange color', () => {
      const tasks = [
        createMockTask({ id: 1, name: 'High Task', priority: 'high' }),
      ];
      const { container } = render(
        <TaskCalendar tasks={tasks} onTaskClick={mockOnTaskClick} />
      );
    ...
    it('should render tasks with medium priority with yellow color', () => {
      const tasks = [
        createMockTask({ id: 1, name: 'Medium Task', priority: 'medium' }),
      ];
      const { container } = render(
        <TaskCalendar tasks={tasks} onTaskClick={mockOnTaskClick} />
      );
    ...
    it('should render tasks with low priority with blue color', () => {
      const tasks = [
        createMockTask({ id: 1, name: 'Low Task', priority: 'low' }),
      ];
      const { container } = render(
        <TaskCalendar tasks={tasks} onTaskClick={mockOnTaskClick} />
      );
    ...
    it('should render tasks with default (none) priority with gray color', () => {
      const tasks = [
        createMockTask({ id: 1, name: 'Default Task', priority: 'none' }),
      ];
      const { container } = render(
        <TaskCalendar tasks={tasks} onTaskClick={mockOnTaskClick} />
      );
  ...
  describe('Date Handling', () => {
    ...
    it('should handle empty string date in task', () => {
      const tasks = [
        createMockTask({ id: 1, name: 'Empty Date Task', date: '' }),
      ];
    ...
    it('should handle null date in task', () => {
      const tasks = [
        createMockTask({ id: 1, name: 'Null Date Task', date: null as any }),
      ];
    ...
    it('should handle tasks across multiple days', () => {
      ...
      const tasks = [
        createMockTask({
          id: 1,
          name: 'Day 1',
          date: `${currentYear}-${String(currentMonth + 1).padStart(2, '0')}-${String(day1).padStart(2, '0')}`,
        }),
        createMockTask({
          id: 2,
          name: 'Day 15',
