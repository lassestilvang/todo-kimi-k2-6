...
describe("API Middleware Edge Cases", () => {
  ...
  describe("Query Parameter Edge Cases", () => {
    it("should handle array query parameters", async () => {
      const request = new NextRequest("http://localhost/api/tasks?tags=tag1&tags=tag2&tags=tag3");
    ...
    it("should handle special characters in query params", () => {
      const request = new NextRequest("http://localhost/api/tasks?q=hello%20world%26special");
      const url = new URL(request.url);
    ...
    it("should handle encoded unicode in query params", () => {
      const request = new NextRequest("http://localhost/api/tasks?name=%F0%9F%98%80");
      const url = new URL(request.url);
