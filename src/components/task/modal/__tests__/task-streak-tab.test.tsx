  ...
  StreakCalendar: ({
    ...
    >
      ...
      <button
        ...
        onClick={() => onDateToggle?.('2024-01-15')}
      >
        Toggle Date
      </button>
    </div>
...
describe('TaskStreakTab Component', () => {
  ...
  describe('Description Text', () => {
    it('should render the description text', () => {
      ...
      expect(
        screen.getByText(/Track your progress on this recurring task/)
      ).toBeInTheDocument();
    });
    ...
    it('should mention building streak', () => {
      ...
      expect(
        screen.getByText(/Mark it complete each day to build your streak/)
      ).toBeInTheDocument();
    });
  });
  ...
  describe('Date Handling', () => {
    it('should pass the task date to calendar', () => {
      ...
      expect(screen.getByTestId('streak-calendar')).toHaveAttribute(
        'data-current-date',
        '2024-03-15'
      );
    });
  ...
  describe('Task Name Handling', () => {
    ...
    it('should handle long task names', () => {
      ...
      expect(screen.getByTestId('streak-calendar')).toHaveAttribute(
        'data-task-name',
        'A very long task name that might need to be truncated in the UI'
      );
    });
  });
