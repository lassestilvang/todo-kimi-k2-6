...
describe('Textarea Component Structure', () => {
  describe('Component Rendering', () => {
    ...
    it('should pass through placeholder prop', async () => {
      ...
      expect(screen.getByTestId('placeholder-textarea')).toHaveAttribute(
        'placeholder',
        'Enter description'
      );
    });
    ...
    it('should pass through value prop', async () => {
      const { Textarea } = await import('../textarea');
      render(
        <Textarea value="test text" readOnly data-testid="value-textarea" />
      );
    ...
    it('should handle onChange events', async () => {
      ...
      render(
        <Textarea onChange={handleChange} data-testid="change-textarea" />
      );
    ...
    it('should pass through name attribute', async () => {
      ...
      expect(screen.getByTestId('name-textarea')).toHaveAttribute(
        'name',
        'description'
      );
    });
    ...
    it('should pass through id attribute', async () => {
      ...
      expect(screen.getByTestId('id-textarea')).toHaveAttribute(
        'id',
        'desc-textarea'
      );
    });
    ...
    it('should have data-slot attribute', async () => {
      ...
      expect(screen.getByTestId('slot-textarea')).toHaveAttribute(
        'data-slot',
        'textarea'
      );
    });
