...
vi.mock("lucide-react", () => ({
  Brain: ({ className }: { className?: string }) => <span className={className} data-testid="brain-icon">🧠</span>,
  Clock: ({ className }: { className?: string }) => <span className={className} data-testid="clock-icon">⏰</span>,
  MapPin: ({ className }: { className?: string }) => <span className={className} data-testid="mappin-icon">📍</span>,
  Smile: ({ className }: { className?: string }) => <span className={className} data-testid="smile-icon">😊</span>,
  Battery: ({ className }: { className?: string }) => <span className={className} data-testid="battery-icon">🔋</span>,
  Coffee: ({ className }: { className?: string }) => <span className={className} data-testid="coffee-icon">☕</span>,
  Globe: ({ className }: { className?: string }) => <span className={className} data-testid="globe-icon">🌍</span>,
}));
...
const createMockContext = (overrides: Partial<HabitContext> = {}): HabitContext => ({
  id: 1,
  task_id: 1,
  user_id: 1,
...
describe("TaskContextTab", () => {
  ...
  describe("Initial Render", () => {
    ...
    it("shows description text", () => {
      ...
      expect(screen.getByText(/Track when you're most productive/)).toBeInTheDocument();
    });
  ...
  describe("Context Value Buttons", () => {
    ...
    it("selecting a value highlights the button", () => {
      ...
      const morningButton = screen.getByText("Morning (6am-12pm)").closest("button");
      if (morningButton) {
  ...
  describe("Context Stats Display", () => {
    it("shows stats section when contexts exist", () => {
      const contexts: HabitContext[] = [
        createMockContext({ id: 1, context_type: "time_of_day", frequency: 5, success_rate: 80 }),
      ];
