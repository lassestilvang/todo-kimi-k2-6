...
describe("integrations module", () => {
  ...
  describe("sendSlackNotification", () => {
    ...
    it("should include priority in notification", async () => {
      ...
      await sendSlackNotification(
        "https://hooks.slack.com/services/test",
        { ...validNotification, priority: "high" }
      );
    ...
    it("should include due date when provided", async () => {
      ...
      await sendSlackNotification(
        "https://hooks.slack.com/services/test",
        { ...validNotification, dueDate: "2024-12-25" }
      );
  ...
  describe("sendDiscordNotification", () => {
    ...
    it("should use colorMap instead of color for Discord", async () => {
      ...
      await sendDiscordNotification(
        "https://discord.com/api/webhooks/test",
        { ...validNotification, priority: "critical" }
      );
  ...
  describe("sendEmailNotification", () => {
    ...
    it("should send email notification successfully", async () => {
      ...
      const { sendEmailNotification } = await import("@/lib/integrations/index");
      const result = await sendEmailNotification("test@example.com", validNotification);
