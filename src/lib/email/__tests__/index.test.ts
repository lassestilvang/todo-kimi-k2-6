  ...
  describe('validateSmtpConfig', () => {
    ...
    it('should warn about port 25 without secure', () => {
      ...
      expect(warnSpy).toHaveBeenCalledWith(
        'Warning: Using non-encrypted SMTP on port 25'
      );
      warnSpy.mockRestore();
    });
  });
  ...
  describe('notification settings', () => {
    ...
    it('should return true for reminders when enabled', async () => {
      ...
      const result = await shouldSendNotification(
        1,
        { id: 1, name: 'Test', description: null, deadline: '2025-01-01' },
        'reminder'
      );
    ...
    it('should return false for unknown notification type', async () => {
      const result = await shouldSendNotification(
        1,
        { id: 1, name: 'Test', description: null, deadline: null },
        'invalid' as 'overdue' | 'reminder' | 'due_soon'
      );
