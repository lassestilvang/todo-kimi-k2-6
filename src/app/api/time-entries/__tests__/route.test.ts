...
describe('Time Entries API', () => {
  ...
  describe('GET /api/time-entries', () => {
    it('should return entries for task', async () => {
      const request = createMockRequest(
        'http://localhost/api/time-entries?taskId=1'
      );
  ...
  describe('DELETE /api/time-entries', () => {
    ...
    it('should delete time entry by id', async () => {
      const request = createMockRequest(
        'http://localhost/api/time-entries?id=1',
        {
          method: 'DELETE',
        }
      );
  ...
  describe('Error handling - catch blocks coverage', () => {
    ...
    it('should handle error in PUT (line 69)', async () => {
      ...
      (updateTimeEntry as any).mockRejectedValueOnce(
    ...
    it('should handle error in DELETE (lines 81-82)', async () => {
      ...
      (deleteTimeEntry as any).mockRejectedValueOnce(
